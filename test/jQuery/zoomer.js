			...
			if(typeof d.speedView!="undefined"||typeof d.speedRemove!="undefined"||typeof d.altAnim!="undefined"||typeof d.speedTitle!="undefined"){
					...
					$(this).hover(function(){
						...
						$(this).find('img').addClass("hover").stop().animate({
							marginTop:'0px',marginLeft:'0px',top:'50%',left:'50%',width:'30px',height:'31px',padding:'0px'},d.speedView
						);
					if(d.altAnim==true){
						...
						$('.title').animate({marginLeft:'-42px',marginTop:'90px'},d.speedTitle).css({'z-index':'10','position':'absolute','float':'left'})
							...
							$(this).find('img').removeClass("hover").stop().animate({
								marginTop:'0',marginLeft:'0',top:'0',left:'0',width:'20px',height:'21px',padding:'0px'},d.speedRemove);$(this).find('.title').remove()
								});
							}};
						})(jQuery);