    ...
    Rating.prototype = {
        ...
        listen: function () {
            ...
            self.listenClick(self.$rating, function (e) {
                ...
                $.ajax({
                    url: '/home/RateStar',
                    data: { star: self.$element.val(), ProductId: $("#MainProductId").html() },
                    type: "Get",
                    ...
                    success: function (res) {
                        if (res == false) {
                            ...
                            $.ajax({
                                url: "/home/login?ReturnUrl=" + "/home/productdetail?ProductId=" + $("#MainProductId").html(),
        ...
        generateRating: function () {
            var self = this,
                ...
                stars = self.getStars();
            if (validateAttr(self.$element, 'disabled', self.options) == false) {
