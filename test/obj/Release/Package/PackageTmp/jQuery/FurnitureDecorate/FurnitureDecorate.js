...
function init() {
    ...
    wall1 = new THREE.Mesh(wall1_P, new THREE.MeshBasicMaterial({ color: 0xfdfdfd, map: THREE.ImageUtils.loadTexture('/images/FurnitureDecorate/Layout/America/america_wall_1.jpg') }));
    wall2 = new THREE.Mesh(wall2_P, new THREE.MeshBasicMaterial({ color: 0xfdfdfd, map: THREE.ImageUtils.loadTexture('/images/FurnitureDecorate/Layout/America/america_wall_2.jpg') }));
    ...
    basePlane = new THREE.Mesh(new THREE.BoxGeometry(550, 550, 1), new THREE.MeshBasicMaterial({ color: 0xfdfdfd, map: THREE.ImageUtils.loadTexture('/images/FurnitureDecorate/Layout/America/america_plane.jpg') }));
...
function ChangeStyle() {
    ...
    switch ($(this).val()) {
        case "1": //美式
            wall1.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/America/america_wall_1.jpg")
            wall2.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/America/america_wall_2.jpg")
            basePlane.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/America/america_plane.jpg")
            break;
        case "2": //北歐
            wall1.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/Nordic/nordic_wall_1.jpg")
            wall2.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/Nordic/nordic_wall_2.jpg")
            basePlane.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/Nordic/nordic_plane.jpg")
            break;
        case "3": //日式
            wall1.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/Japan/japan_wall_2.jpg")
            wall2.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/Japan/japan_wall_1.jpg")
            basePlane.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/Japan/japan_plane.jpg")
            break;
        case "4": //簡約
            wall1.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/Simple/simple_wall_2.jpg")
            wall2.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/Simple/simple_wall_1.jpg")
            basePlane.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/Simple/simple_plane.jpg")
            break;
        case "5": //鄉村
            wall1.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/Country/country_wall_2.jpg")
            wall2.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/Country/country_wall_1.jpg")
            basePlane.material.map = THREE.ImageUtils.loadTexture("/images/FurnitureDecorate/Layout/Country/country_plane.jpg")
            break;
    }
}
